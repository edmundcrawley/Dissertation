\chapter{Monetary Policy Transmission with Many Agents}
...
\input ./Chapter3/Python/DoloCode/Tables/calib_table.tex
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.7]{./Chapter3/Python/DoloCode/Figures/ProportionKeynesian_sigma1.pdf}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.55]{./Chapter3/Python/DoloCode/Figures/KeynesianDebt_sigma1.pdf}
		\includegraphics[scale=0.55]{./Chapter3/Python/DoloCode/Figures/KeynesianDebt_sigma2.pdf}
		\includegraphics[scale=0.55]{./Chapter3/Python/DoloCode/Figures/KeynesianDebt_sigma3.pdf}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.7]{./Chapter3/Python/DoloCode/Figures/TANK_capital_IRF_k.pdf}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.5]{./Chapter3/Python/DoloCode/Figures/TANK_capital_IRF_i.pdf}
		\includegraphics[scale=0.5]{./Chapter3/Python/DoloCode/Figures/TANK_capital_IRF_c_K.pdf}
		\includegraphics[scale=0.5]{./Chapter3/Python/DoloCode/Figures/TANK_capital_IRF_c_R.pdf}
...
\input ./Chapter3/Python/DoloCode/Tables/error_table.tex
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.7]{./Chapter3/Python/DoloCode/Figures/TANK_capital_IRF_q.pdf}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{./Chapter3/Python/Figures/IRF_C.pdf} \includegraphics[scale=0.45]{./Chapter3/Python/Figures/IRF_PI.pdf} \\
		\includegraphics[scale=0.45]{./Chapter3/Python/Figures/IRF_RB.pdf}
		\includegraphics[scale=0.45]{./Chapter3/Python/Figures/IRF_W.pdf}
...
\input ./Chapter3/Python/Tables/Decomposition.tex
