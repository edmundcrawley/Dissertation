...
\frame{
	...
	\begin{center}
	\only<1>{
		\includegraphics[scale=0.6]{./Chapter3/Python/DoloCode/Figures/ProportionKeynesian_sigma1_slides_a.pdf}}
	\only<2>{
		\includegraphics[scale=0.6]{./Chapter3/Python/DoloCode/Figures/ProportionKeynesian_sigma1_slides.pdf}
	}
\end{center}
}
\frame{
	...
	\begin{center}
	\includegraphics[scale=0.6]{./Chapter3/Python/DoloCode/Figures/KeynesianDebt_sigma1_slides.pdf}
	\end{center}
}
\frame{
	...
	\begin{itemize}
		\item Change in wealth distribution induces little persistence
